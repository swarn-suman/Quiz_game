...
int main()
    ...
    system("cls");
    printf("\n ------------------  Welcome to Swarn's Quiz Game --------------------------",playername);
    printf("\n\n Some tips for playing the Quiz:");
    printf("\n -------------------------------------------------------------------------");
    printf("\n * There are 2 rounds in this Quiz Game,WARMUP ROUND & CHALLANGE ROUND");
    printf("\n * In warmup round there will be 5 questions to test your");
    printf("\n    general knowledge. You will be eligible to play the game if you correct minimum 3");
    printf("\n    questions, otherwise you can't proceed further to the CHALLANGE ROUND.");
    printf("\n * Your Quiz starts with the CHALLANGE ROUND. In this round you will be asked ");
    printf("\n    15 questions. You will get Rs.10,000 for each correct answer.");
    printf("\n * Each question will have 4 options and you have to press A, B ,C or D for the");
    printf("\n    right option.");
    ...
    system("cls");
     ...
     switch(r1)
		...
		case 1:
		printf("\n\nWhat is 'cynophobia'?");
		printf("\n\nA.Fear of dogs\t\tB.Fear of height\n\nC.Fear of water\t\tD.Fear of cats");
		if (toupper(getch())=='A')
			{
		       ...
		       {
		           printf("\n\nWrong!!! The correct answer is A.Fear of dogs");
		           getch();
		       break;
		       }
		...
		printf("\n\nA.George Garton\t\tB.Willian steinfield\n\nC.Ferdinand Magellan\t\tD.M.Kardova");
		if (toupper(getch())=='C')
			{printf("\n\nCorrect answer!");count++;
			getch();
			break;}
		else
		       {printf("\n\nWrong!!! The correct answer is C.Ferdinand Magellan");
		       getch();
		       break;}
        ...
        case 6:
		printf("\n\n\nWhat is the group of sheeps known as?");
		printf("\n\nA.A heard\t\tB.A toddler\n\nC.A flock\t\tD.An Army");
		if (toupper(getch())=='C' )
			{printf("\n\nCorrect answer!");count++;
			getch();
			break;}
		else
		       {printf("\n\nWrong!!! The correct answer is C.A flock");
		       getch();
		       break;}}
		       }
	...
	goto mainhome;
     ...
     test:
     system("cls");
     printf("\n\n\t*** congrats %s !!! Go to next level ***",playername);
...
game:
     ...
     switch(r)
		...
		if (toupper(getch())=='A')
			{printf("\n\nCorrect answer!");countr++;getch();
			 break;}
		       ...
		       {printf("\n\nWrong!!! The correct answer is A.Pacific");getch();
		       goto score;
		       break;}
		...
		printf("\n\nA.Coulomb\t\tB.Watt\n\nC.Power\t\tD.Units");
		if (toupper(getch())=='B')
			{printf("\n\nCorrect answer!");countr++;getch(); break;}
		else
		       {
...
void help()
    ...
    printf("\n >> Your game starts with the CHALLANGE ROUND. In this round ");
    printf("\n    15 questions will be asked each right answer will be awarded Rs.10,000.");
	...
	printf("\n\n\t*********************BEST OF LUCK*********************************");
	printf("\n\n\t*****QUIZ is created by SWARN SUMAN********");}
